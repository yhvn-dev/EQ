...
function Sidebar() {
  return (
    <aside className='w-full h-full center col-start-1 col-span-full row-start-1 row-end-3 shadow-lg'>

        <div className="w-[20%] center">LOGO</div>
        <div className='w-full flex items-center justify-evenly '>
            <NavLink className={({isActive}) => (`text-[0.8rem] column  text-white shadow-lg rounded-xl bg-[var(--metal-dark4)] center px-4 py-2 ${isActive ? 
